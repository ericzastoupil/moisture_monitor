all: tests/test_mem_pool tests/test_ring_buffer tests/test_scheduler tests/test_hal
...
clean:
	rm -f tests/test_mem_pool tests/test_ring_buffer tests/test_scheduler tests/test_hal